...
/** The configuration a piece opens at: one mould or the default quantity, with what it comes with. */
export function defaultSelection(product: Product): Selection {
  return {
    quantity: product.size === null ? DEFAULT_UNIT_QUANTITY : SINGLE_UNIT,
